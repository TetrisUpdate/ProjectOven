...
Init_All:
	...
	mov	P0M1, #0x00
	mov	P0M2, #0x00
	;mov P0M5, #0x00 ;initialize pin 0.5
	...
	orl AINDIDS, #0b10010000 ; P1.1 is analog input
...
Forever:
    ...
    swap a
    push acc
    anl a, #0x0f ; 12-bit ADC, moves high 6 bits to R1
    mov R1, a
    pop acc
    anl a, #0xf0 ;Moves low 6 bits to R0
    orl a, ADCRL
    mov R0, A
